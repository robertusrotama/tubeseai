            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Input Data Untuk Gaji Pegawai</h2>
...
<table>
    ...
    <tr>
        <td width="130">Divisi</td>
        <td><select name="divisi">
            <option value="HR">HR</option>
            <option value="Finance">Finnance</option>
    ...
    <tr>
        <td width="130">Pangkat</td>
        <td><select name="pangkat">
